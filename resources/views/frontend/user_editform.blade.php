...
<style>
  ...
  <div class="mainBody">
    ...
    <div style="max-height: 99999px;">
      <form name="f" id="submit-all" method="post" action="{{route('adupdate', $edit->id)}}" enctype="multipart/form-data">
        @csrf
       @method('PUT') 
        ...
        <div class="editAdField">
          ...
          <div class="content">
            <input type="text" name="title" id="name" maxlength="60" minlength="2" class="required largeInput" value="{{@$edit->title}}" required>
          </div>
        ...
        <div class="editAdField">
          ...
          <div class="content">
            ...
            <div id="sample">
              ...
              <textarea name="desc" id="description" cols="40">{{@$edit->desc}}</textarea>
              <br />
            </div>
          </div>
        </div>
        ...
        <div class="editAdField">
          ...
          <div class="content">
            <div class="pac-card" id="pac-card">
              <input id="loc" name="location" type="text" class="required mediumInput" placeholder="Enter a location" value="{{@$edit->location}}">
            </div>
        ...
        <div class="editAdField">
          ...
          <div class="content">
            <input type="text" name="email" id="email" maxlength="50" class="mediumInput" value="{{@$edit->email}}" placeholder="Enter a email address">
          </div>
        </div>
        <div class="editAdField">
          <div class="header">Contact Mobile Number</div>
          <div class="content">
            <input type="text" name="phone" id="phone" maxlength="20" class="mediumInput" value="{{@$edit->mobile}}" placeholder="Enter a contact mobile number">
          </div>
        </div>
        <br>
        <br>
        <div id="imageEditModule">
          ...
          <div class="form-group">
            ...
            {{-- <div class="" style="border: 1px solid #1b0602; max-width:64px; max-height:64px">
              ...
              <img src="{{(!empty($edit->logo))?URL::to('storage/'.$edit->logo):URL::to('image/no_image.png')}}" alt="" style="max-height: 63px; max-width:63px">
            </div>--}}
      ...
      <span class="editAdTitles">
        ...
        <span class="editAdTitles">
          ...
          <span id="nearbyTotalPriceArea"> for <span id="nearbyTotalPrice" data-near="0.25">{{$edit->cost}}</span>
          </span>
          <br>
